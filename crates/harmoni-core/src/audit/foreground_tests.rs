...
fn should_return_dark_candidate_foreground_when_background_is_very_light() {
    ...
    let result = get_best_foreground(&example_background, &example_dark_candidate, None, None);
...
fn should_return_black_when_dark_candidate_fails_and_black_beats_white() {
    ...
    let result = get_best_foreground(&light_background, &light_dark_candidate, None, None);
...
fn should_pick_white_in_fallback_when_neither_passes_aa() {
    ...
    let result = get_best_foreground(&mid_background, &bad_dark_candidate, None, None);
...
fn should_pick_black_in_fallback_when_black_has_higher_ratio() {
    ...
    let result = get_best_foreground(&very_light_bg, &bad_dark_candidate, None, None);
